...
@Component
public class NormalMemberFileUtil {
	 public List<FileDto> parseFileInfo(MultipartHttpServletRequest uploadFiles, String normarEmail) throws Exception {
...
//	               사용하여 파일 이름을 겹치지 않도록 함.
	               ...
	               data.setNormalEmail(normarEmail);
	               data.setFileName("/" + path + "/" + newFileName);
	               fileList.add(data);
