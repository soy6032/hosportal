			...
			$.ajax({
				...
				success : function(Dermatology) {
					...
					for(var i = 0; i < Dermatology.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+Dermatology[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
			...
			$.ajax({
				...
				success : function(Dentist) {
					...
					for(var i = 0; i < Dentist.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+Dentist[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
						...
						$("#hospitalAddr"+i+"").append(
								"<h5 class='small my-2 text-muted text-center'>"+Dentist[i].hospitalAddress2+"</h5>"
								);
						$("#hospitalName"+i+"").append(
			...
			$.ajax({
				...
				success : function(Ophthalmology) {
					...
					for(var i = 0; i < Ophthalmology.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+Ophthalmology[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(medicine) {
					...
					for(var i = 0; i < medicine.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+medicine[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Orientalmedicine) {
					...
					for(var i = 0; i < Orientalmedicine.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+Orientalmedicine[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Obstetricsandgynecology) {
					...
					for(var i = 0; i < Obstetricsandgynecology.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+Obstetricsandgynecology[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(PlasticSurgery) {
					...
					for(var i = 0; i < PlasticSurgery.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+PlasticSurgery[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(DepartmentofPediatricsandAdolescents) {
					...
					for(var i = 0; i < DepartmentofPediatricsandAdolescents.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+DepartmentofPediatricsandAdolescents[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Otorhinolaryngology) {
					...
					for(var i = 0; i < Otorhinolaryngology.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+Otorhinolaryngology[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
						...
						$("#hospitalImg"+i+"").append(
								"<img src='"+Otorhinolaryngology[i].fileName+"' width='100%' height='100%' th:unless='"+Otorhinolaryngology[i].fileName+" != null'>" 
								);
						$("#hospitalAddr"+i+"").append(
			...
			$.ajax({
				...
				success : function(DepartmentofFamilyMedicine) {
					...
					for(var i = 0; i < DepartmentofFamilyMedicine.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+DepartmentofFamilyMedicine[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(DepartmentofMentalHealthMedicine) {
					...
					for(var i = 0; i < DepartmentofMentalHealthMedicine.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+DepartmentofMentalHealthMedicine[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(DepartmentofRehabilitationMedicine) {
					...
					for(var i = 0; i < DepartmentofRehabilitationMedicine.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+DepartmentofRehabilitationMedicine[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(surgery) {
					...
					for(var i = 0; i < surgery.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+surgery[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Orthopedics) {
					...
					for(var i = 0; i < Orthopedics.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+Orthopedics[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Neurology) {
					...
					for(var i = 0; i < Neurology.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+Neurology[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(urology) {
					...
					for(var i = 0; i < urology.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/normal/hospital/detail/"+urology[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
