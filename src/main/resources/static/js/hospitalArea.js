			...
			$.ajax({
				...
				success : function(Seoul) {
					...
					for(var i = 0; i < Seoul.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Seoul[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
			...
			$.ajax({
				...
				success : function(Incheon) {
					...
					for(var i = 0; i < Incheon.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Incheon[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Gyeonggi) {
					...
					for(var i = 0; i < Gyeonggi.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Gyeonggi[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Chungbuk) {
					...
					for(var i = 0; i < Chungbuk.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Chungbuk[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Chungnam) {
					...
					for(var i = 0; i < Chungnam.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Chungnam[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Gangwon) {
					...
					for(var i = 0; i < Gangwon.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Gangwon[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Sejong) {
					...
					for(var i = 0; i < Sejong.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Sejong[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Daejeon) {
					...
					for(var i = 0; i < Daejeon.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Daejeon[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Gyeongbuk) {
					...
					for(var i = 0; i < Gyeongbuk.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Gyeongbuk[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Gyeongnam) {
					...
					for(var i = 0; i < Gyeongnam.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Gyeongnam[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Daegu) {
					...
					for(var i = 0; i < Daegu.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Daegu[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Jeollabuk) {
					...
					for(var i = 0; i < Jeollabuk.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Jeollabuk[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Jeollanam) {
					...
					for(var i = 0; i < Jeollanam.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Jeollanam[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Gwangju) {
					...
					for(var i = 0; i < Gwangju.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Gwangju[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Ulsan) {
					...
					for(var i = 0; i < Ulsan.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Ulsan[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Busan) {
					...
					for(var i = 0; i < Busan.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Busan[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
			...
			$.ajax({
				...
				success : function(Jeju) {
					...
					for(var i = 0; i < Jeju.length; i++) {
						...
						$("#hospitalNo"+i+"").append(
				                "<a href='/hospital/hospital/detail/"+Jeju[i].hospitalId+"' style='text-decoration: none;' id='hospitalCard"+i+"'></a>"
								);
						$("#hospitalCard"+i+"").append(
			                    "<div class='hospitalImg' id='hospitalImg"+i+"'></div>",
								"<div class='hospitalAddr mt-3 p-2' id='hospitalAddr"+i+"'></div>",
